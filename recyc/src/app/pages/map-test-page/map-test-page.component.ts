...
export class MapTestPageComponent implements OnInit, OnDestroy {
  ...
  addFeatureLayers() {
    ...
    var geojsonLayer: __esri.FeatureLayer = new FeatureLayer({
      url: "https://services8.arcgis.com/8uwvxgdH7NZ8TVsx/arcgis/rest/services/project_layer/FeatureServer/0"
    });

    this.map.add(geojsonLayer, 0);
